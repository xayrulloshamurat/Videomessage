...
import com.example.videomessages.data.models.LoginUser
import com.example.videomessages.data.models.UserToken
...
class LoginViewModel(private val api: ApiInterface) : ViewModel(){
    ...
    fun loginUser(username: String, password: Int) {
        _login.value = Resource.loading()
        compositeDisposable.add(
            api.loginUser(loginUser = LoginUser(username = username, password = password))
